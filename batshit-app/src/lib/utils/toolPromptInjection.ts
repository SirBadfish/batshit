...
export function buildMemoryPromptBlock(options?: {
  ...
  return [
    ...
    '- Your awareness entries compile into the AWARENESS section of your system prompt instead; new or changed entries take effect immediately, riding the `Awareness updates` section of your current message until they fold into the AWARENESS block at the next nap, dream, or new session. Entries with Clip media list the media textually — recall the memory when you need to see it.',
